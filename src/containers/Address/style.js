...
export default StyleSheet.create({
  ...
  tabStyle: { backgroundColor: Colors.white,borderLeftColor:Colors.white,paddingBottom:0,paddingLeft:0,paddingRight:0,marginLeft:0,marginRight:0,},
  activetab: { backgroundColor: Colors.white, paddingBottom:0,paddingLeft:0,paddingRight:0,marginLeft:0,marginRight:0,},
  activetext: { color:Colors.RedThemeColor, fontSize: Dimension.font14, fontFamily: Dimension.CustomSemiBoldFont,},
  tabtext: { color: Colors.PrimaryTextColor, fontSize: Dimension.font14, fontFamily: Dimension.CustomRegularFont, },
  addressWrap:{
